        ...
        <div className="flex flex-col xl:flex-row gap-12 items-start">
          ...
          <article className="flex-1 min-w-0">
            ...
            <div className="mb-10 bg-white/5 border border-white/10 rounded-2xl p-6">
                <div className="text-white font-black text-sm uppercase tracking-wider mb-5 flex items-center gap-2"><BookOpen size={14} className="text-teal-400" /> Table of Contents</div>
