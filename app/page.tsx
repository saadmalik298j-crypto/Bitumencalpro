        ...
        <div id="calculator" className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-wrap justify-center gap-2 sm:gap-4 mb-14">
            {TRUST_BADGES.map(({ icon: Icon, label }) => (
              <div
                key={label}
                className="flex items-center gap-2 bg-black/20 border border-white/10 rounded-full px-4 py-2 text-white text-xs sm:text-sm font-medium justify-center backdrop-blur-sm shadow-inner hover:bg-black/30 transition-colors"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-teal-500/20 to-transparent border-l-4 border-teal-400 text-white px-4 py-2 rounded-r-lg text-sm font-bold mb-6 backdrop-blur-sm">
            ...
            <div className="lg:w-1/2 w-full">
              <div className="relative rounded-[2rem] p-4 sm:p-6 bg-gradient-to-br from-white/10 to-white/5 border border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.3)] backdrop-blur-md group">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-orange-500/20 border border-orange-500/30 text-orange-100 px-5 py-2 rounded-full text-sm font-bold mb-6 backdrop-blur-sm shadow-[0_0_15px_rgba(249,115,22,0.2)]">
              <Compass size={16} />
              Quick Start Guide
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
            {/* Step 1 */}
            <div className="bg-gradient-to-b from-white/10 to-transparent backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-white/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(0,0,0,0.3)]">
            ...
            {/* Step 2 */}
            <div className="bg-gradient-to-b from-white/10 to-transparent backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-white/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(0,0,0,0.3)] mt-0 md:mt-12">
              <div className="absolute -top-4 -right-4 p-4 opacity-5 group-hover:opacity-10 group-hover:scale-125 transition-all duration-500 text-white">
                <Settings size={140} />
              </div>
            ...
            {/* Step 3 */}
            <div className="bg-gradient-to-b from-white/10 to-transparent backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden group hover:border-white/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_40px_rgba(0,0,0,0.3)] mt-0 md:mt-24">
              <div className="absolute -top-4 -right-4 p-4 opacity-5 group-hover:opacity-10 group-hover:scale-125 transition-all duration-500 text-white">
                <Lightbulb size={140} />
              </div>
          ...
          <div className="mt-20 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-2xl border border-white/10 rounded-[2rem] overflow-hidden shadow-2xl max-w-5xl mx-auto">
      ...
      <section id="how-it-works" className="py-24 bg-black/20 border-y border-white/5 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center mb-16">
            <div className="lg:w-1/2">
              <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/20 to-transparent border-l-4 border-blue-400 text-white px-4 py-2 rounded-r-lg text-sm font-bold mb-6 backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
            {STEPS.map((step) => {
              ...
              return (
                <div key={step.num} className="rounded-3xl border border-white/10 bg-gradient-to-br from-white/5 to-transparent backdrop-blur-xl p-8 shadow-2xl hover:border-white/30 transition-all duration-300 flex flex-col group hover:-translate-y-1">
          ...
          <div className="mt-8 bg-gradient-to-r from-emerald-500/20 to-teal-600/20 rounded-3xl border border-emerald-500/30 p-8 md:p-10 shadow-[0_0_40px_rgba(16,185,129,0.1)] backdrop-blur-md">
          ...
          <div className="mt-8 bg-gradient-to-r from-orange-500/20 to-red-600/20 border border-orange-500/30 rounded-3xl p-8 flex flex-col md:flex-row items-start gap-6 backdrop-blur-sm shadow-[0_0_30px_rgba(249,115,22,0.1)]">
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
            ...
            {/* Concept 1 */}
            <div className="bg-gradient-to-br from-white/10 to-transparent backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 md:p-10 shadow-2xl hover:border-white/20 transition-all group">
            ...
            {/* Concept 2 */}
            <div className="bg-gradient-to-br from-white/10 to-transparent backdrop-blur-xl border border-white/10 rounded-[2rem] p-8 md:p-10 shadow-2xl hover:border-white/20 transition-all flex flex-col justify-between">
              <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-16">
            <div className="order-2 lg:order-1">
              ...
              <div className="bg-white/5 border border-white/10 rounded-[2rem] overflow-hidden text-base shadow-2xl backdrop-blur-md">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            {/* Box 1 */}
            <div className="bg-gradient-to-b from-white/10 to-transparent border border-white/10 rounded-[2rem] p-8 hover:border-white/30 transition-all duration-300 backdrop-blur-xl shadow-xl hover:-translate-y-1">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-1/2 order-1 lg:order-2">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-orange-500/10 to-transparent border border-orange-500/20 p-6 rounded-3xl backdrop-blur-sm shadow-lg hover:bg-orange-500/10 transition-colors">
                ...
                <div className="bg-gradient-to-r from-white/10 to-transparent border border-white/10 p-6 rounded-3xl backdrop-blur-sm shadow-lg hover:bg-white/10 transition-colors">
      ...
      <section id="reference" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            {/* Table side */}
            <div className="bg-gradient-to-br from-white/10 to-transparent backdrop-blur-2xl rounded-[2.5rem] p-8 md:p-12 shadow-2xl border border-white/20">
              ...
              <div className="space-y-4">
                {REFERENCE_DATA.map((item) => (
                  <div key={item.name} className="flex justify-between items-center p-5 rounded-2xl border border-white/10 bg-black/30 backdrop-blur-sm transition-all cursor-default hover:bg-black/50 hover:scale-[1.02] shadow-lg">
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-orange-500/10 to-transparent p-6 rounded-3xl border border-orange-500/20 shadow-lg hover:border-orange-500/40 transition-colors">
                  <h4 className="text-2xl font-black text-orange-400 mb-3">Marshall Method</h4>
                ...
                <div className="bg-black/30 p-8 rounded-3xl border border-white/10 shadow-inner">
                  ...
                  <ul className="text-white/80 text-base space-y-4">
                    <li className="flex items-start gap-3"><span className="text-white font-bold w-1/3">AASHTO / MS-2</span> <span className="w-2/3 text-white/60">Widely referenced mix design procedures in North America.</span></li>
                    ...
                    <li className="flex items-start gap-3"><span className="text-white font-bold w-1/3">MoRTH specifications</span> <span className="w-2/3 text-white/60">The standard reference for road and bridge works in India.</span></li>
                  </ul>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="bg-gradient-to-br from-orange-500/20 to-pink-600/20 backdrop-blur-xl rounded-[2rem] p-8 md:p-10 border border-white/20 shadow-2xl">
              ...
              <div className="bg-gradient-to-br from-red-900/20 to-black/40 backdrop-blur-md rounded-[2rem] p-8 border border-red-500/20 shadow-xl">
                <h3 className="text-2xl font-black text-white mb-6 flex items-center gap-3">
            ...
            <div className="lg:col-span-7">
              ...
              <div className="mt-16 bg-gradient-to-br from-teal-500/20 via-blue-600/20 to-purple-600/20 rounded-[2.5rem] p-10 md:p-12 border border-white/20 backdrop-blur-xl shadow-[0_0_50px_rgba(0,0,0,0.3)]">
